package com.example.cukaapellampung.session;
...
import com.example.cukaapellampung.admin.HomeAdminActivity;
import com.example.cukaapellampung.pembeli.HomePembeliActivity;
...
public class PrefSetting {
    ...
    public void storeRegIdSharedPreferences(Context context, String _id, String userName, String namaLengkap,
                                            String email, String noTelp, String role, SharedPreferences prefs){
